<template>
  ...
  >
    ...
    <v-row>
      <v-col cols="4">
        <v-card class="ma-6 elevation-11" dark color="grey">
          <v-card-text>
            Taken
          </v-card-text>
        </v-card>
      ...
      <v-col cols="4">
        <v-card class="ma-6 elevation-11" dark color="info">
          <v-card-text>
            Avilable
          </v-card-text>
        </v-card>
      ...
      <v-col cols="4">
        <v-card class="ma-6 elevation-11" dark color="success">
          <v-card-text>
            Selected
          </v-card-text>
        </v-card>
      ...
      >
        <v-row dense>
            ...
            >
                ...
                <v-btn class="ma-4" :disabled="ticket.customer_id != null" :color="ticket.status == false ? 'info' : 'success'" @click="add(ticket)">{{ ticket.seat_number }}</v-btn>
            </v-col>
            <!-- <v-col cols="1">
            </v-col> -->
        </v-row>
...
import Layout from '@shared/BaseLayout'
  export default {
    ...
    methods: {
      ...
      submit(){
        this.sending = true
        this.$inertia.post(this.route('search.booking.store'), this.customer_tickets)
      },
      init(){
